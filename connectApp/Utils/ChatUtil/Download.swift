...
func uploadImage(image: UIImage, chatRoomId: String, view: UIView, completion: @escaping (_ imageLink: String?) -> Void) {
    ...
    let startOfFileName = FUser.currentID() + "/" + chatRoomId + "/" + dateString
    let fileExtension = ".jpg"
    let photoFileName = "PictureMessages/" + startOfFileName + fileExtension
...
func uploadVideo(video: NSData, chatRoomId: String, view: UIView, completion: @escaping(_ videoLink: String?) -> Void) {
    ...
    let videoFileName = "VideoMessages/" + startOfFileName + fileExtension
...
func uploadAudio(autioPath: String, chatRoomId: String, view: UIView, completion: @escaping(_ audioLink: String?) -> Void) {
    ...
    let audioFileName = "AudioMessages/" + startOfFileName + fileExtension
